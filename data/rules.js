const $kurlc_rules = [
    ...
    },
    {
        ...
        rules: ['_t', 'spm', 'algo_pvid', 'algo_expid', 'btsid', 'ws_ab_test', 'initiative_id', 'origin', 'widgetId', 'tabType', 'productId', 'productIds', 'gps-id', 'scm', 'scm_id', 'scm-url', 'pvid', 'algo_exp_id', 'pdp_ext_f', 'pdp_pi', 'fromRankId', 'sourceType', 'utparam', 'gatewayAdapt', '_evo_buckets', 'fromDetail', 'item_id', 'tpp_rcmd_bucket_id', 'scenario']
    },
    {
        name: 'google.com',
        match: /www.google\..*/i,
